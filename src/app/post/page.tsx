      ...
      <div className="container mx-auto max-w-7xl px-4 pb-12">
        {!user && (
          <Alert className="mb-6 border-primary/50 text-primary text-center">
            ...
            <AlertDescription>
              يجب عليك <Link href="/login?redirect=/post" className="font-bold underline">تسجيل الدخول</Link> أو <Link href="/signup?redirect=/post" className="font-bold underline">إنشاء حساب جديد</Link> أولاً لتتمكن من نشر إعلان.
            </AlertDescription>
          </Alert>
        )}
