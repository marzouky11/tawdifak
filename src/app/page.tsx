...
import { getCachedHomePageJobs, getCachedHomePageWorkers, getCachedHomePageCompetitions, getCachedHomePageImmigration, getCachedGlobalStats, getCachedHomePageTestimonials } from '@/lib/data';
...
async function getHomePageData(): Promise<HomePageData> {
  const [
    ...
    getCachedHomePageJobs(),
    getCachedHomePageWorkers(),
    getCachedHomePageCompetitions(),
    getCachedHomePageImmigration(),
