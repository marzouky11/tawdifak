...
import { Flag, Loader2, AlertTriangle, MessageSquare } from 'lucide-react';
          ...
          <form ref={formRef} onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="py-4 space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-3">
                    <FormLabel className="flex items-center gap-2 text-base md:text-lg"><AlertTriangle className="h-4 w-4" /> سبب الإبلاغ</FormLabel>
                    <FormControl>
                      <RadioGroup
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-base md:text-lg"><MessageSquare className="h-4 w-4" /> تفاصيل إضافية (اختياري)</FormLabel>
                    <FormControl>
                      <Textarea
