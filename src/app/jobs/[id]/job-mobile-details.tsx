...
const InfoItem = ({ icon: Icon, label, value, color }: { icon: React.ElementType; label: string; value: string | number | undefined; color?: string }) => {
    ...
    return (
      <div className="flex items-center gap-3 bg-background rounded-lg p-3 border border-border/60">
                ...
                <Card className="overflow-hidden shadow-lg border-2" style={{ borderColor: sectionColor }}>
                    <CardHeader className="p-4" style={{ backgroundColor: `${sectionColor}1A` }}>
                        <div className="flex items-center gap-3 mb-3">
                            <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl shadow-sm ring-1 ring-black/5 dark:ring-white/10" style={{ backgroundColor: `${categoryColor}1A` }}>
