...
const InfoRow = ({ icon: Icon, label, value }: { icon: React.ElementType; label: string; value: string | number | undefined }) => {
  ...
  return (
    <div className="flex items-start gap-3 py-2.5 px-4 w-1/2 sm:w-1/3 lg:w-1/5">
            ...
            <div className="space-y-6">
                ...
                <Card className="overflow-hidden shadow-lg">
                    ...
                    <CardContent className="pt-0 text-center -mt-10">
                        ...
                        <dl className="flex flex-wrap justify-center text-right divide-x divide-border/70 dark:divide-border/40">
