...
const InfoBadge = ({ icon, text, className }: { icon?: React.ElementType, text: string | number | undefined, className?: string }) => {
  ...
  const Icon = icon;
  return (
    <Badge variant="secondary" className={cn("inline-flex items-center gap-1.5 font-normal text-xs py-1 px-2 border flex-1 min-w-0", className)}>
  ...
  return (
    ...
    >
      ...
      <CardFooter className="p-4 pt-0 mt-auto flex items-center justify-between">
        ...
        <Button asChild size="sm" variant="secondary" className="text-sm active:scale-95 transition-transform text-secondary-foreground hover:bg-secondary/80">
